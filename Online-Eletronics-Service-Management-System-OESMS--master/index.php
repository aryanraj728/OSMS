...
<head>
  ...
  <title>E-Reparar</title>
</head>

<body>
  <!-- Start Navigation -->
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark bg-danger p1-5 fixed-top">
    <a href="index.php" class="navbar-brand">E-Reparar</a>
    <span class="navbar-text">Always For You</span>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/istockphoto-1211747471-612x612.jpg);">
    <div class="myclass mainHeading">
      <h1 class="text-uppercase font-weight-bold">Welcome to E-Reparar</h1>
      <p class="font-italic">Always For You</p>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      <h3 class="text-center">OESMS Services</h3>
      <p>
        E-Reparar Services is one of the leading chain of multi-brand Electronics and Electrical service
        workshops offering
  ...
  <div class="jumbotron bg-dark" id="Customer">
    ...
    <div class="container">
      ...
      <h2 class="text-center text-white">Reviews by Our Customers</h2>
      <div class="row mt-5">
        <div class="col-lg-3 col-sm-6">
          <!-- Start Customer 1st Column-->
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/Passport-Size-Pic.jpg" class="img-fluid" style="border-radius: 100px;">
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/images (1).jpg" class="img-fluid" style="border-radius: 100px;">
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/images (2).jpg" class="img-fluid" style="border-radius: 100px;">
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/download.jpg" class="img-fluid" style="border-radius: 100px;">
              <h4 class="card-title">Priyanshu Raj</h4>
              <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad
                ducimus voluptas
                nesciunt debitis numquam.</p>
            </div>
  ...
  <div class="container" id="Contact">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        ...
        Kankarbagh,<br>
        Patna, <br>
        Bihar pin:- 1234567 <br>
        Phone: 1234567890 <br>
        <a href="#" target="_blank">www.oesms.com</a> <br>

        <br><br>
        <strong>Punjab Branch:</strong> <br>
        OESMS Pvt Ltd, <br>
        Phagwara,<br>
        Punjab,Pin:-12345 <br>
        Phone: 1234567890 <br>
    ...
    <div class="container">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6 text-right">
          ...
          <small> Designed by Aryan Raj : 2022.
          </small>
